...
export default function EditVehiclePage() {
  ...
  // Reset form when vehicle data is loaded
  React.useEffect(() => {
    if (vehicle) {
      reset({
  ...
  const updateVehicleMutation = useMutation({
    ...
    onSuccess: (updatedVehicle) => {
      ...
      toast.success(`Vehicle "${updatedVehicle.plate_number}" updated successfully!`);
        ...
        <div className="space-y-6">
          ...
          <PageHeader
            ...
            breadcrumbs={[
              ...
              { label: vehicle.plate_number, href: `/vehicles/${id}` },
              { label: 'Edit' }
            ]}
            actions={
              <Button
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`block w-full pl-10 pr-3 py-2 border rounded-md shadow-sm placeholder-gray-400 text-gray-900 bg-white focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition-colors uppercase ${
                    ...
                    <div className="relative">
                      ...
                      {watch('make') === 'Other' && (
                        <input
                          type="text"
                          {...register('make', { required: 'Vehicle make is required' })}
                          className="mt-2 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 text-gray-900 bg-white focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition-colors"
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-gray-500">
                      Vehicle is active and can be used for new jobs and services.
                    </p>
                  </div>
                </div>
              </CardContent>
